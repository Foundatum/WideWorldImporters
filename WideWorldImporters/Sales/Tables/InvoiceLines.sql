...
GO
CREATE NONCLUSTERED INDEX [IX_Sales_InvoiceLines]
    ON [Sales].[InvoiceLines]([InvoiceID] ASC, [StockItemID] ASC, [Quantity] ASC, [UnitPrice] ASC, [LineProfit] ASC, [LastEditedWhen] ASC);
